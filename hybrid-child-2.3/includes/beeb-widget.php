...
<?php if ($count == 1) : ?>		
 <?php if ( current_theme_supports( 'get-the-image' ) ) get_the_image( array( 'custom_key' => false, 'Thumbnail' => false, 'default_size' => 'img-catlight-right', 'image_scan' => true, 'default_image' => './wp-content/uploads/images/default_thumb.gif' ) ); ?>

 	<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2><span class="published"><?php echo do_shortcode('[entry-published]'); ?></span>
...
<li><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php short_title('', '', true, '36'); ?></a>,&nbsp;<span class="date"><?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ago'; ?></span></li>
<?php endif; ?>
<?php endif; ?>
<?php
	}	
...
echo $after_title;
	while ( $cat_posts->have_posts() )
	{
		$cat_posts->the_post();
	?>		
<div style="border-bottom:1px solid #ccc;margin-bttom:10px;">
	<h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3><span class="published"><?php echo do_shortcode('[entry-published]'); ?></span>
<?php if ( current_theme_supports( 'get-the-image' ) ) get_the_image( array( 'custom_key' => false, 'Thumbnail' => false, 'default_size' => 'img-thumb', 'image_scan' => true, 'default_image' => './wp-content/uploads/images/default_thumb.gif' ) ); ?>
