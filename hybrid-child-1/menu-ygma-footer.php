...
<div id="ygmacx">
	     ...
	     <div id="ygmafrm" class="sitesearch" style="float:left;">
<? // TOP SIDEBAR ?>
<!-- Site Search Google -->
...
<font size="-1" color="#000"><?php _e( 'This Site', hybrid_get_textdomain() ); ?></font>
...
<!-- Yahoo! Search --><div style="float:right;padding-right:15px;">
