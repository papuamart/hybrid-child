        ...
        function widget($args, $instance) {
            if(is_single()) {
                ...
                if ($trailing_posts && count($trailing_posts)) {
                    echo $before_widget_2 . $before_title . $title_before . $after_title . "<div class=sidebarheader><ul>";
                ...
                if ($leading_posts && count($leading_posts)) {
                    echo $before_widget . $before_title . $title_after . $after_title . "<div class=sidebarheader><ul>";
