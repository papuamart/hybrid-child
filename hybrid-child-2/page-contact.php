...
<?php do_atomic( 'before_entry' ); // hybrid_before_entry ?>		
	...
	echo "/images/icons/information.png' alt='" . __('Profile','ml'). "' /><h3>" . __('Hey','ml') . " " . $displayName . ",</h3><p>".__('thanks for your message! I\'ll get back to you as soon as possible.','ml')."</p></div>";
						}
					}
					?>
