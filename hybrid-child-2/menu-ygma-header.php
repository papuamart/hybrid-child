...
<div id="ygmacx">
<div id="ygmatop">
		<div class='vsep cms-dynamic' style="float:right;padding-right:25px;"><?php get_search_form(); ?></div>
<a href="mailto:info@coffea.biz"><?php _e( 'EMail Us!', hybrid_get_textdomain() ); ?></a>
		<!-- USER AND WEB ADMIN -->
